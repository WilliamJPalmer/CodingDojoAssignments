...
--------------------------------------------------------------------------------
rake db:drop     # deletes ALL your data
rake db:create   # creates fresh new clean database
rake db:migrate
...
--------------------------------------------------------------------------------
I wanted to share an optional process to store sensitive data like email address or passwords. As I noted above, I use Figaro to manage Environment Variables.

So, if you want to integrate it as a means of protecting your usernames, passwords, api keys, etc... Here you go.

1) Navigate to your Gem File and Add the following: gem 'figaro', '~> 1.1', '>= 1.1.1'
 ) In the terminal, run: bundle install
2) In the terminal, run: bundle exec figaro install
3) Navigate to Config > Application.yml
4) Create a configuration value for your email address, password, etc. Example: gmail_address: myemail@example.com (there are examples in place already)
5) Navigate to Config > Environments > Development.rb, and replace your gmail and password with the following format:
user_name: ENV['gmail_address'],
password: ENV['gmail_password']

Save your work, restart your server, and test a registration. :-)

Sorry if I'm jumping ahead, Leo... Just don't like to risk accidentally committing sensitive data it to a public Git repo.

More on Figaro here: https://github.com/laserlem...
--------------------------------------------------------------------------------
